...
Recipe cache shard for **[foodrecipes.page](https://foodrecipes.page)** — AI-generated recipes whose slug starts with **the letter 'h'**.
...
```
https://cdn.jsdelivr.net/gh/foodrecipes-page/recipes-h@main/recipes/<cuisine>/<diet>/<slug>.json
```
